...
FairyGUI-cocos2dx只提供了C++版本，Lua Binding需要由你自行完成。或者参考网上的资料，例如：

1. [Cocos-lua](https://github.com/zhongfq/cocos-lua)
2. [FairyGUI在Cocos2d-x下的多平台接入和lua绑定](https://www.jianshu.com/p/547e584e05d8)